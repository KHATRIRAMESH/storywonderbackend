...
router.get('/apple/callback', authenticateAppleCallback, authController.handleOAuthSuccess);
...
router.get('/subscription', authenticateJWT, userController.getUserSubscription);
